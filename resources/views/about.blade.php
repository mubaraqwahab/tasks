    ...
    <main>
      ...
      >
        ...
        <p>
          ...
          <a href="https://www.smashingmagazine.com/2016/11/true-lies-of-optimistic-user-interfaces/">"optimistic UI"</a>, which enables a seamless user experience. In the (hopefully) rare
        ...
        <p>
          Learning from that experience, I built this app with <a href="http://laravel.com/">Laravel</a>.
          Laravel is a full-stack PHP framework with a
          <a href="https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller">model-view-controller (MVC) architecture</a>
        ...
        <p>
          <a href="https://github.com/mubaraqwahab/tasks">The source code is available on my GitHub</a>,
          and the tech stack is as follows:
        </p>

        <ul>
          <li>Laravel for the overall architecture and backend heavy lifting</li>
